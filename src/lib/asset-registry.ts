...
export const UD_ASSETS_SEED: UdAsset[] = [
  ...
  // ══════════════════════════════════════════
  {
    ...
    name: 'ACTT (ACT Test) — 실행 성장 측정 진단 (사전·사후 페어 필수)',
    category: 'methodology',
    applicableSections: ['proposal-background', 'coaches', 'impact'],
    valueChainStage: 'activity',
    evidenceType: 'methodology',
    keywords: [
      'ACTT', 'ACT Test', '액트프러너십', '5대 역량', '진단', 'GEPXR',
      '실행력', '리더십', '문제해결', '협업', '시장중심',
      '외부 검증', '임팩트 리서치랩', '사전사후', '교육효과', 'pre-post',
      '성장 측정', '변화량',
    ],
    narrativeSnippet:
      'ACTT (ACT Test 의 약자) — 언더독스가 자체 개발한 실행 성장 측정 진단 도구. 우리 프로그램을 통해 참가자가 **얼마나 제대로 된 실행으로 성장했는지** 가 핵심. 10개 차원·30 문항·5점 리커트 척도로 인지→적용→실행 3단계 갭을 정량화한다. **반드시 교육 사전·사후 2회 페어로 실시** — 사전·사후 둘 다 없으면 변화량 측정 자체가 불가능. 사전 진단으로 참가자 기초 역량을 측정하고, 사후 진단으로 교육·코칭에 따른 변화량(Δ)을 정량 입증한다. 2024 임팩트 리서치랩 협업 사회성과 연구(N=1,002) 에서 5대 역량(실행력·리더십·문제해결·협업·시장중심) 평균 4.09/5.0, 역량-성과 상관계수 r=.78 외부 검증 완료. 사전→사후 실행단계 변화량 +1.10 — 평가위원의 "이 교육이 실제 효과 있나?" 의심에 정량 답변.',
    keyNumbers: [
      '5대 역량', '15 세부 지표', '평균 4.09/5.0', 'r=.78', 'N=1,002',
      '사전·사후 페어 (분리 불가)', 'Δ+1.10',
    ],
    status: 'stable',
